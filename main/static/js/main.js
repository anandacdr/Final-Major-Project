...
sad_playlist = ["Adele-Hello", "CelineDion-MyHeartWillGoOn", "GaryJules-MadWorld", "Maya-Sad"];
sad_title = ["Adele - Hello", "Celine Dion - My Heart Will Go On", "Gary Jules - Mad World", "Maya Naraunu - Ayush Gauchan"];
sad_poster = ["static/song_imgs/hello.JPG", "static/song_imgs/my_heart_will_go_on.jpg", "static/song_imgs/maya.jpg", "static/song_imgs/maya.jpg"];
        ...
        fetch('/expression', {
            ...
            switch (mood) {
                ...
                case "Sad":
                    ...
                    $("body").css("background-image", "linear-gradient(to bottom, rgba(2,0,36,1) 0%, rgba(121,9,54,1) 35%, rgba(0,212,255,1) 100%)");
                    break;
            }
        });
    });
